...
@endif
    ...
    <div class="contenedor seccion">
        ...
        <div class="card-body">
            <form class="formulario" method="post" action="{{route('base.updateempleado', $user = auth()->user()->id)}}" enctype="multipart/form-data">
                @csrf
                {!! method_field('PUT')!!}
                <fieldset style="background-color: #24272480;">
                    <legend>Información General</legend>
                        ...
                        <input class="form-control" type="file" id="imagen" accept="image/*" name="fileempleado" required>
